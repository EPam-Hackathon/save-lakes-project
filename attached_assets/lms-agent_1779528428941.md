...
* **Notification Center** This screen shold include notifications from the Firebase database which has the list of messages that include information about campaigns that they are invited for. The firebase notifications table should have the required information. This can be accessed by all users. 
